            ...
            <div >
                ...
                <div className="container-fluid pb100 pt50" >
                    <div  className="container pt100 pb100 furnished ">
                        ...
                        <NavLink to="/create" className="btn  btn-green"><span>Start renting out</span></NavLink>
                    </div>
                </div>
                         ...
                         <div className="container good-hands pb100">
                            ...
                            <div className="good-hands-container pt50 ">
                                <div className="good-hands-items">
                                    ...
                                    <div className="start-renting-box" ><NavLink to="/create" className="btn  btn-green pt100"><span>Start renting out</span></NavLink></div>
                                </div>
                                <div className="good-hands-items">
                                    <ul>
